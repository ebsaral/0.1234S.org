...
const daglarDagladi: Soundcloud = {
    src: "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/287867484&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true",
    info: {
      artist: {
          title: "dj tutan",
          url: "https://soundcloud.com/dj-tutan"
      },
      song: {
        title: "Edip Akbayram Daglar Dagladi Sound Sanayi Mix",
        url: "https://soundcloud.com/dj-tutan/daglar-dagladi-sound-sanayi-mix"
      }
    }
}
