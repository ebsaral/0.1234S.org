...
export default function Quote() {
  ...
  return (
    <div onClick={() => next()} className="relative flex align-middle items-center justify-center-80 p-6 border rounded-xl shadow-lg select-none cursor-pointer hover:bg-gray-800 hover:border-gray-800 min-h-60 max-w-lg">
