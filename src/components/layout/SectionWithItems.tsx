...
export default function SectionWithItems({translationPaths, items = [], minCol, maxCol, id, displayTitle}: SectionWithItemsType) {
    const t = useTranslations();
    return <div id={id} className="page-section [&:not(:last-child)]:mb-12">
        {displayTitle && <div className="mb-6 text-center text-3xl font-bold font-[family-name:var(--font-geist-mono)] whitespace-pre-line">
